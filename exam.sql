...
create table public."FMHS_exam_teacher_assignments" (
  id bigint generated by default as identity not null,
  exam_id bigint null,
  ...
  constraint teacher_assignments_exam_id_teacher_email_class_section_sub_key unique (
    exam_id,
    teacher_email,
    class,
    section,
  ...
  constraint teacher_assignments_exam_id_fkey foreign KEY (exam_id) references "FMHS_exams_names" (id) on delete CASCADE
) TABLESPACE pg_default;
...
create table public."FMHS_exam_subject_selection" (
  id bigint generated by default as identity not null,
  exam_id bigint null,
  subject_code text not null,
  ...
  constraint subject_table_pkey primary key (id),
  constraint FMHS_exam_subject_selection_exam_id_fkey foreign KEY (exam_id) references "FMHS_exams_names" (id) on delete CASCADE
) TABLESPACE pg_default;

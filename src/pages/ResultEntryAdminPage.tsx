            ...
            <table key={tableVersion} style={tableStyle}>
              <thead>
                <tr style={{ background: '#f0f3f6', color: '#000' }}>
                  ...
                  {comps.Total && <th style={{ border: '1px solid #d0d7de', padding: headerPadding, textAlign: 'center', fontSize: isMobile ? '9px' : '13px', lineHeight: 1.1 }}>{isMobile ? 'Tot' : 'Total'}</th>}
                  {comps.GPA && <th style={{ border: '1px solid #d0d7de', padding: headerPadding, textAlign: 'center', fontSize: isMobile ? '9px' : '13px', lineHeight: 1.1 }}>GPA</th>}
